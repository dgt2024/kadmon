...
rawcodeprintloop:
	...
	mov cl, 1
	call asciicodeprint
	mov edi, 0xFD0CF008 ; offset  a.k.a address
	mov al, '2'-' '
	mov cl, 0
	call asciicodeprint
	mov cl, 1
	call asciicodeprint
	mov edi, 0xFD0CF00E ; offset  a.k.a address
	mov al, '3'-' '
	mov cl, 0
	call asciicodeprint
	mov cl, 1
	call asciicodeprint
	mov edi, 0xFD0CF014 ; offset  a.k.a address
	mov al, '4'-' '
	mov cl, 0
	call asciicodeprint
	mov cl, 1
...
.repeatrow:
	...
	pop eax
.skippixel:
	cmp ecx, 0x10000000 ;  it crashed at 0x4000000
	je .godown
	cmp ecx, 0x2000000
	je .godown
	cmp ecx, 0x100000
...
asciidatabase: ;  a bunch of bitmaps, a.k.a. .bmp files
	;times (' '-1)*8 dd 0; 32 chars, each 2 dw 64 dw?
