...
start:
	...
	int 0x10
	mov ah, 0x02
	mov al, 8 ; number of sectors like at the end
	mov ch, 0
	mov cl, 1
	mov dh, 0
	mov dl, 0x80
...
background_loop:
	...
	mov es, dx
	mov esi, kasmonlogo
	mov ecx, kasmonlogoend - kasmonlogo
	shr ecx, 1
	xor eax, eax
kasmonlogoloop:
...
print_mouse:
	...
	mov ecx, mousecursorend - mousecursor ; ecx = 1
	mov esi, mousecursor ; esi = ???
	shr ecx, 1
.looping:
...
rawcodeprintloop:
    ...
    add eax, 0x0F
	stosb ; mov word [es:edi], ax
	loop rawcodeprintloop
	mov edi, 0xFD0CF002 ; offset  a.k.a address
	mov bl, 0
	mov al, 'H' ; char
	mov cl, 0
	call asciicodeprint
	...
	call asciicodeprint
	ret
asciicodeprint: ; its not printing fully, just half
...
.skippixeladd:
	inc edi
	jmp .skippixel
; this comment under is probably the one that chose the structure of this whole proyect
; from here until whenever i want, textures are, a.k.a db, dw, dq, and dd and more...
kasmonlogo: ; 1-color version of an .img
...
; smaller version of a .img file with 2 colors
	...
	dw 0x8C00, 0x0C01, 0x0C02, 0x0C03, 0x8C04
	dw 0x9000, 0x1001, 0x1002, 0x1003, 0x1004, 0x9005
	dw 0x9400, 0x1401, 0x1402, 0x1403, 0x1404, 0x1405, 0x9406
	dw 0x9800, 0x1801, 0x1802, 0x1803, 0x1804, 0x1805, 0x1806, 0x9807
	dw 0x9C00, 0x1C01, 0x1C02, 0x1C03, 0x1C04, 0x1C05, 0x1C06, 0x1C07, 0x9C08
	dw 0xA000, 0x2001, 0x2002, 0x2003, 0x2004, 0x2005, 0x2006, 0x2007, 0x2008, 0xA009
	dw 0xA400, 0x2401, 0x2402, 0x2403, 0x2404, 0x2405, 0x2406, 0x2407, 0x2408, 0x2409, 0xA40A
	dw 0xA800, 0x2801, 0x2802, 0x2803, 0x2804, 0x2805, 0x2806, 0x2807, 0x2808, 0x2809, 0x280A, 0xA80B
	dw 0xAC00, 0x2C01, 0x2C02, 0x2C03, 0x2C04, 0x2C05, 0x2C06, 0x2C07, 0xAC08, 0xAC09, 0xAC0A, 0xAC0B
	dw 0xB000, 0x3001, 0x3002, 0xB003, 0xB004, 0x3005, 0x3006, 0xB007
	dw 0xB400, 0x3401, 0xB402		 , 0xB404, 0x3405, 0x3406, 0xB407
	dw 0xB800, 0xB801        				 , 0xB805, 0x3806, 0x3807, 0xB808
...
rawlogo:
    ...
    dw 0x0C11, 0x0C12, 0x0C13, 0x0C13
    dw 0x0C15, 0x0C16, 0x0C17, 0x8C18
    dw 0x9000, 0x9001, 0x1002, 0x1003
    dw 0x1004, 0x1005, 0x9006, 0x1007
    ...
    dw 0x3C08, 0x3C09, 0xBC0A, 0xBC0B
    ...
    dw 0xC80C, 0xC80D, 0x280E, 0x280F
    ...
    dw 0xD40C, 0xD40D, 0x040E, 0x540F
    ...
    dw 0xDC18
rawlogoend:
asciidatabase: ;  a bunch of bitmaps, a.k.a. .bmp files
	...
	dd 000000000000000000000000000000b ; ^
	dd 000000000000000000000000000000b
	dd 000000000000000000000000011111b ; _
...
times 512 * 8 - ($ - $$) db 0 ; just to know if I surpass limit to add another secto
